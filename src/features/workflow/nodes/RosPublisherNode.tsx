...
const RosPublisherNode = memo(({ data }: NodeProps<RosPublisherNodeData>) => (
    ...
    <CardContent>
      ...
      <Box sx={{ mb: 2 }}>
        <TextField
          ...
          onChange={(evt) => {
            data.topicName = evt.target.value;
          }}
          sx={{ mb: 1 }}
        />
        <TextField
          ...
          onChange={(evt) => {
            data.messageType = evt.target.value;
          }}
          sx={{ mb: 1 }}
        />
        <TextField
          ...
          onChange={(evt) => {
            data.messageContent = evt.target.value;
          }}
        />
      </Box>
