...
const styles: Record<string, React.CSSProperties> = {
  ...
  disabledBanner: { padding: '16px', backgroundColor: '#2a2a2a', borderRadius: '10px', textAlign: 'center', color: '#888', marginBottom: '20px' },
  ...
  intensityBar: { height: '6px', backgroundColor: '#333', borderRadius: '3px', overflow: 'hidden' },
  intensityFill: { height: '100%', borderRadius: '3px', transition: 'width 0.3s' },
  moodChange: { fontSize: '12px', color: '#888' },
  moodPicker: { marginTop: '12px', padding: '16px', backgroundColor: '#252525', borderRadius: '12px' },
  moodCategory: { marginBottom: '12px' },
  categoryLabel: { display: 'block', fontSize: '12px', color: '#888', marginBottom: '8px' },
  moodGrid: { display: 'flex', gap: '8px', flexWrap: 'wrap' },
  moodBtn: { width: '44px', height: '44px', fontSize: '24px', backgroundColor: '#333', border: 'none', borderRadius: '8px', cursor: 'pointer' },
  ...
  trait: { padding: '6px 12px', backgroundColor: '#333', borderRadius: '16px', fontSize: '12px' },
  ...
  modal: { backgroundColor: '#1a1a1a', borderRadius: '16px', padding: '24px', width: '400px', maxWidth: '90%' },
  modalTitle: { margin: '0 0 20px', fontSize: '18px', fontWeight: 600 },
  input: { width: '100%', padding: '12px 14px', backgroundColor: '#252525', border: '1px solid #333', borderRadius: '8px', color: '#fff', fontSize: '14px', marginBottom: '12px', boxSizing: 'border-box' },
  textarea: { width: '100%', padding: '12px 14px', backgroundColor: '#252525', border: '1px solid #333', borderRadius: '8px', color: '#fff', fontSize: '14px', resize: 'none', boxSizing: 'border-box' },
  modalActions: { display: 'flex', gap: '12px', justifyContent: 'flex-end', marginTop: '16px' },
  cancelBtn: { padding: '10px 20px', backgroundColor: '#333', border: 'none', borderRadius: '8px', color: '#fff', cursor: 'pointer' },
