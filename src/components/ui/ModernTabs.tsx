...
export function ModernTabs({
  ...
  const variantStyles = {
    default: {
      container: 'bg-slate-800/30 p-1 rounded-lg',
      button: `
        px-4 py-2 rounded-md transition-all duration-200
        hover:bg-slate-700/50
      `,
      active: 'bg-slate-700 shadow-lg',
    ...
    pills: {
      ...
      `,
      active: 'bg-gradient-to-r from-blue-500 to-purple-500 text-white border-transparent',
      inactive: 'text-slate-400 border-slate-700/50',
    },
    underline: {
      container: 'border-b border-slate-700/50 gap-6',
      button: `
